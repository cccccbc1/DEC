...
# sdae_savepath = "./model/csdae-74.pt"
# sdae_savepath = ("./DEC85/sdae.pt")
...
# X = torch.cat([mnist_train.train_data, mnist_test.test_data])
# y = torch.cat([mnist_train.train_labels, mnist_test.test_labels])
...
dec.fit(X, y, lr=0.1, batch_size=256, num_epochs=1,
        update_interval=1)
